    ...
    * ---------------------------------------------------- */ 
    const ssMailChimpForm = function() {
        ...
        function hasError(field) {
            ...
            if (validity.valueMissing) return 'Inserisci un indirizzo mail valido.';

            // If not the right type
            if (validity.typeMismatch) {
                if (field.type === 'email') return 'Inserisci un indirizzo mail valido.';
            }
            ...
            return 'Il valore inserito non è un formato corretto.';
